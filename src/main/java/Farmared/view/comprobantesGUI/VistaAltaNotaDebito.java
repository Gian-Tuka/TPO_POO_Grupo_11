...
public class VistaAltaNotaDebito extends JDialog {
    ...
    public VistaAltaNotaDebito(JFrame parent) {
        ...
        JLabel lblTitulo = new JLabel("Nueva Nota de Débito");
        ...
        JButton btnGuardar = new JButton("Guardar Nota de Débito");
    ...
    private void guardar() {
        try {
            ...
            if (idxProv <= 0) {
                JOptionPane.showMessageDialog(this, "Debe seleccionar un proveedor.", "Atención",
            ...
            if (desc.isEmpty()) {
                JOptionPane.showMessageDialog(this, "La descripción no puede estar vacía.", "Atención",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "El monto debe ser un número mayor a 0.", "Error",
            ...
            NotaDebitoDTO dto = new NotaDebitoDTO(cuit, desc, monto, nroFactura);
            ControladorComprobantes.getInstance().registrarNotaDebito(dto);
            JOptionPane.showMessageDialog(this, "Nota de Débito registrada exitosamente.", "Éxito",
